...
{
    public class CausticsLightDirectionFeature : ScriptableRendererFeature
    {
        [System.Serializable]
    ...
    {
        private readonly CausticsLightDirectionFeature.CausticsSettings settings;
        private static readonly int MainLightDirection = Shader.PropertyToID("_MainLightDirection");

        public CausticsPass(CausticsLightDirectionFeature.CausticsSettings settings)
        {
