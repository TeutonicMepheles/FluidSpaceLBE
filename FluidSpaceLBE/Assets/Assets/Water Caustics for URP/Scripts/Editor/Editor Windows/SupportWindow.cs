        ...
        private void ClickedButton(EventBase tab)
        {
            ...
            switch (button.name)
            {
                ...
                case "Unity Version Fix":
                    ...
                    break;
                case "URP_version_fix":
                    Application.OpenURL("https://docs.unity3d.com/Packages/com.unity.render-pipelines.universal@12.1/manual/index.html");
                    break;
        ...
        private void CheckUnityVersion()
        {
            ...
            switch (unityVersionComparison)
            {
                ...
                case var value when value > 0:
                    ...
                    unityVersionFix.SetEnabled(true);
                    break;
                // same version
                case var value when value == 0:
        ...
        static void DetectIssues()
        {
            ...
            switch (DetectRenderPipeline())
            {
                ...
                case PipelineType.Universal:
                    ...
                    var rendererData = ExtractScriptableRendererData();
                    CausticsLightDirectionFeature causticsLightDirectionFeature = rendererData.rendererFeatures.OfType<CausticsLightDirectionFeature>().FirstOrDefault();
                    if (causticsLightDirectionFeature != null)
                    {
                        ...
                        if (!causticsLightDirectionFeature.isActive)
                        {
