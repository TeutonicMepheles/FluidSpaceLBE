...
public class TeleportationManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        PlayerManager.Instance.PlayerInVisBoundary_EventHandler += PlayerInVisBoundary;
    }
    ...
    private void PlayerInVisBoundary(object sender, PlayerManager.PlayerBoundStateEventArgs e) // 接受玩家是否在区域中的广播，修改Ray Interactor的可交互层
    {
    ...
    private BoundaryManager SpawnTempBoundary(int index) // 跟随Reticle生成边界用
    {
